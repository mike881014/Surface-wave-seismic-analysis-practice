...
pmin=1/500; pmax=1/70; dp=(pmax-pmin)/200; % Wavelength Range
...
[f,p,A]=fp(y,dt,x,fmin,fmax,df,pmin,pmax,dp);
...
ylabel('Frequency (Hz)');
hold on;
plot(pe(4:length(pe)-2),fe(4:length(pe)-2),'r.');hold on;